...
A demo for a restaurant management system. The system assists restaurant managers in managing their ingredient inventory. It has basic CRUD funtionalality and was developed using Python Tkinter. There are two main pages on the Restaurant-Manager, "Inventory" and "Order". Both pages have several functionalites 
